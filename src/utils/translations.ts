export const translations: Record<string, Record<string, unknown>> = {
  ko: {
    ...
    auth: {
      ...
      checkEmail: '이메일 인증 없이 바로 로그인할 수 있어요.',
      goToLogin: '로그인 페이지로',
      myPage: '마이페이지',
      editProfile: '프로필 수정',
    ...
    site: {
      nav: {
        ...
        learn: '학습하기',
        learnUnderstand: 'AI 이해하기',
        learnWisely: 'AI 안전하게 쓰기',
        tools: 'AI 도구',
        toolsHub: 'AI 도구 한눈에',
        toolChatgpt: 'ChatGPT 가이드',
        toolClaude: 'Claude 가이드',
      ...
      home: {
        title: 'AI Free Academy',
        subtitle: '무료요금제로 시작하는 생성형 AI 활용 학습',
        welcome: '무료 AI 활용 학습 플랫폼에 오신 것을 환영합니다.',
        description: 'ChatGPT · Claude · Gemini · Genspark를 무료요금제로 실습하고, 배당된 토큰으로 유료 모델까지 경험합니다.'
      }
    }
  },
  ...
  en: {
    ...
    auth: {
      ...
      checkEmail: 'Your account is ready — you can log in right away.',
    ...
    site: {
      nav: {
        ...
        learn: 'Learn',
        learnUnderstand: 'Understanding AI',
        learnWisely: 'Use AI Safely',
        tools: 'AI Tools',
        toolsHub: 'All AI Tools',
        toolChatgpt: 'ChatGPT Guide',
        toolClaude: 'Claude Guide',
      ...
      home: {
        title: 'AI Free Academy',
        subtitle: 'Start generative AI on the free tier',
        welcome: 'Welcome to the free generative AI learning platform.',
        description: 'Practice ChatGPT, Claude, Gemini, and Genspark on free tiers, then try paid models with allocated tokens.'
      }
    }
  }
};
