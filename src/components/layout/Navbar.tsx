      ...
      <div className="topbar">
        <div className="container">
          <div className="topbar-left">
            <span className="topbar-tag">무료로 시작하는 생성형 AI 학습</span>
            ...
            <div className="logo">
              <Link to="/">
                <span className="brand-mark">
                  AI<span className="brand-ampersand"> </span><span className="brand-accent">Free</span>
                </span>
                ...
                <div className="nav-user-menu" ref={userMenuRef}>
                  ...
                  {showUserMenu && (
                    <div className="nav-user-dropdown">
                      ...
                      <Link to="/playground" className="dropdown-menu-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                        AI 실습실
                      </Link>
                      {isAdmin && (
                        <Link to="/admin/allocation" className="dropdown-menu-item">
